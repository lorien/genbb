...
`task_tracking.md`, `report_tracking.md`, `adr_tracking.md`) before
working. The spec docs and the workflow files are the authoritative
starting points; the current design lives in `spec/docs/`.